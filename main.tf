...
resource "aws_eks_cluster" "my-cluster-eks" {
...
resource "aws_iam_role" "workernodes" {
 ...
 resource "aws_iam_role_policy_attachment" "AmazonEC2ContainerRegistryReadOnly" {
  ...
  cluster_name  = aws_eks_cluster.my-cluster-eks.name
  node_group_name = "my-cluster-workernodes"
